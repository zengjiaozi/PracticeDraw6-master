...
//   建立很多插值器 动画
    ...
    protected void onAttachedToWindow() {
        ...
        spinner = (Spinner) findViewById(R.id.interpolatorSpinner7);

        animateBt = (Button) findViewById(R.id.animateBt7);
        imageView = (ImageView) findViewById(R.id.imageView7);
        animateBt.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                imageView.animate().translationX(Utils.dpToPixel(250)).setDuration(600).setInterpolator(interpolators[spinner.getSelectedItemPosition()]).withEndAction(new Runnable() {
                    @Override
                    public void run() {
